...
const strukPemesananBintaroImage = async (order) => {
  const outlet = "BOSGIL BINTARO";
  const storeAddress = "Jl. Camat Pd. Aren No.7, Pd. Pucung, Kota Tangerang Selatan Banten 15229.";
