...
const notaReservasiPagesanganImage = async (order) => {
    ...
    <div class="receipt-container">
      <div class="header">
        ...
        <div class="receipt-info">
          <h2 class="receipt-title">NOTA RESERVASI</h2>
      ...
      <div class="footer">
        ...
        <p class="footer-text">Reservasi Anda telah diterima</p>
