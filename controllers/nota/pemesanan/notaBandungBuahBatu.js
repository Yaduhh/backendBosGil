...
export const notaBandungBuahBatu = async (order) => {
  ...
  const norekbca = "8840931901";
  const norekmandiri = "1550012291186";
  const namerekening = "FAJAR MAULANA";
...
module.exports = { notaBandungBuahBatu };