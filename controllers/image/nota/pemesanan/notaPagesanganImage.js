...
const notaPagesanganImage = async (order) => {
    ...
    <div class="receipt-container">
      <div class="header">
        ...
        <div class="receipt-info">
          <h2 class="receipt-title">NOTA PEMESANAN</h2>
      ...
      <div class="payment-info">
        ...
        ${order.metode_pembayaran === 'Transfer BCA' ? `
          <div class="info-row">
            <span class="label">Bank BCA:</span>
            <span class="value">${bank_bca}</span>
          </div>
          <div class="info-row">
            <span class="label">Atas Nama:</span>
            <span class="value">${nama_bank_bca}</span>
          </div>
        ` : ''}
        ${order.metode_pembayaran === 'Transfer Mandiri' ? `
          <div class="info-row">
            <span class="label">Bank Mandiri:</span>
            <span class="value">${bank_mandiri}</span>
          </div>
          <div class="info-row">
            <span class="label">Atas Nama:</span>
            <span class="value">${nama_bank_mandiri}</span>
          </div>
        ` : ''}
      </div>

      <div class="footer">
        <p class="thank-you">Terima Kasih Atas Pesanan Anda</p>
        <p class="footer-text">Pesanan Anda sedang diproses</p>
