...
const strukPemesananPusat = async (order) => {
      ...
      <html>
        ...
        <body>
          <div class="header">
            ...
            <div class="title" style="margin-top:4px; font-weight:500;">PUSAT KARAWACI</div>
          ...
          <div class="thanks" style="margin-top:30px;">TERIMAKASIH ATAS KUNJUNGAN ANDA</div>
          <div class="thanks">BERSAMA BOSGIL #KITAPASTIBISA</div>
...
module.exports = { strukPemesananPusat };