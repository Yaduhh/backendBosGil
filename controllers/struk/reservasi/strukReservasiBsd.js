...
const strukReservasiBsd = async (order) => {
  const outlet = "BOSGIL BSD";
  const storeAddress =
          ...
          <div class="header">
            ...
            <div class="receipt-body">
             ...
             <div class="info" style="margin-top:5px;">No. Telp : <b>0${
              ...
              <div class="info" style="margin-top:5px;">VIP : <b>${
                order.vip}</b></div>
              
              <div class="info" style="margin-top:5px;">Jumlah Tamu : <b> ${order.jumlah_orang} Orang</b>
              </div>
...
module.exports = { strukReservasiBsd };