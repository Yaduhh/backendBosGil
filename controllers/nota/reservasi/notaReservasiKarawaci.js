...
const notaReservasiKarawaci = async (order) => {
  ...
  const nama_bank_bca = "Masakan Segala Acara Karawaci";
  const bank_mandiri = "155 00 1417 1618";
  const nama_bank_mandiri = "Masakan Segala Acara Karawaci";
        ...
        <body>
          <div class="header">
            ...
            <div class="receipt-body">
              ...
              <div class="info" style="margin-top:5px;">VIP ROOM : <b>${
                order.vip
              }</b></div>
              
              <div class="info" style="margin-top:5px;">Jumlah Tamu : <b>${order.jumlah_orang} Orang</b></div>
              
              <div class="info" style="margin-top:5px;">Reservasi Buat : <b>${formatTanggal(
                order.orderanBuat
              )}</b></div>
              <div class="info" style="margin-top:5px;">Waktu Reservasi : <b>${adjustTimeDeliver(
                order.from_jam
              )}</b> - <b>${adjustTimeDeliver(order.until_jam)}</b></div>
...
module.exports = { notaReservasiKarawaci };