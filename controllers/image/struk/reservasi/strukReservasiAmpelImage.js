 ...
 */
const strukReservasiAmpelImage = async (order) => {
  const outlet = "BOSGIL AMPEL";
  const storeAddress = "Jl. KH Mas Mansyur No.144, Ampel, Kec. Semampir, Surabaya, Jawa Timur 60162";
